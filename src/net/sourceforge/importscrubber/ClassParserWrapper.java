    ...
    private static class ClassRefVisitor extends EmptyVisitor
    {
        ...
        public void visitConstantUtf8(ConstantUtf8 obj)
        {
            ...
            if (obj.toString().indexOf('$') != -1) {
                ...
                if (current.length() == 0 || current.startsWith("array") || current.startsWith("access") || current.startsWith("this") || current.startsWith(".") || current.startsWith("constructor") || current.startsWith("L") || current.endsWith(".0") || current.endsWith(".1") || current.endsWith(".2") || current.endsWith(".3") || current.endsWith(".4") || current.endsWith(".5")) {
                    return;
                }
